...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.GroupLabel
      ...
      className={cn("px-2.5 py-1 text-xs text-muted-foreground font-mono", className)}
      {...props}
    />
  )
}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center justify-between gap-2 rounded-xl py-2 px-2.5 text-xs font-mono select-none hover:bg-gray-100 dark:hover:bg-white/10 focus:bg-gray-100 dark:focus:bg-white/10 focus:outline-none transition-colors data-disabled:pointer-events-none data-disabled:opacity-50",
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.ItemIndicator
        render={
          <span className="flex size-4 items-center justify-center text-gray-900 dark:text-white" />
        }
      >
